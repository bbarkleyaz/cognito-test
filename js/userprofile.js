...
var tokens;
var domain = "demousers";
var region = "us-west-2";
var appClientId = "3qv4b9a4mgbmmbfk27a531queh";
var userPoolId = "us-west-2_5zylaFVh3";
var redirectURI = "https://d2f7ill69rw9b9.cloudfront.net/index.html";
    ...
    if(sessionStorage.getItem("pkce_state") != state) {
      ...
      await fetch("https://"+domain+".auth."+region+".amazoncognito.com/oauth2/token?grant_type=authorization_code&client_id="+appClientId+"&code_verifier="+code_verifier+"&redirect_uri="+redirectURI+"&code="+ code,{
        ...
        .then((data) => {
          ...
          // Display tokens
          document.getElementById("id_token").innerHTML = tokens.id_token;
